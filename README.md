...
A integração com o Mercado Pago é super simples e não exige configurações complexas de servidor.

1. Acesse o **Painel de Desenvolvedores do Mercado Pago** em: [https://www.mercadopago.com.br/developers/panel/app](https://www.mercadopago.com.br/developers/panel/app).
2. Crie uma nova **Aplicação**.
3. Acesse a sua aplicação e vá no menu esquerdo em **Credenciais de Produção** (ou Credenciais de Teste para ambiente sandbox).
4. Localize e copie o **Access Token** (Token de Acesso). Ele geralmente começa com `APP_USR-...` ou `TEST-...`.
5. Cole esse Access Token no painel **Admin da Plataforma** > **Configurações**, selecionando a opção do Mercado Pago, no campo **Credenciais / API Token**.
